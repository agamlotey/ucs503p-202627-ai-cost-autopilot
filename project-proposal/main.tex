...
\section{Higher-order goal \BvrHint{...secondary framing}}
...
\section{Time-to-value \BvrHint{...primary heuristic}}
...
\section{Solution Approach \BvrHint{...Engineering focus}}

\subsection{Context reduction \BvrHint{...non-research}}
...
\section{Evaluation Criterion \BvrHint{...measurable and attributable}}
...
\subsection{Validation plan \BvrHint{...high-level}}
...
\section{Scalability \BvrHint{...with foresight}}
...
\section{Project scope and deliverables \BvrHint{...iteration-friendly}}

\subsection{Initial deliverable \BvrHint{...first iteration}}
\begin{itemize}[noitemsep]
