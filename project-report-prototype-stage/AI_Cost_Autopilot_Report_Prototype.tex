...
\begin{tikzpicture}[t/.style={minimum width=4.3cm, minimum height=1.05cm}]
  \node[blueb, t]   (u) at (0,0)     {\textbf{Trimmer Tests (19)}\\{\scriptsize\bfseries collapse, call graph, cross-file}};
  \node[tealb, t]   (c) at (5.0,0)   {\textbf{Cache Tests (17)}\\{\scriptsize\bfseries keys, reuse, no embedder}};
  \node[orangeb, t] (g) at (10.0,0)  {\textbf{Gateway + Autopilot (8)}\\{\scriptsize\bfseries HTTP pipeline, mock provider}};
