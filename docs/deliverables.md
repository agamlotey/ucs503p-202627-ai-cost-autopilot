...
Every item in the project evaluation, in one place, with a link to where it lives.
...
[`code/`](https://github.com/agamlotey/ucs503p-202627-ai-cost-autopilot/tree/master/code):
the gateway and the three components, each with its own tests. See
[Usage](usage.md) to run it.
...
This site. The [Home](index.md) page is the overview, and [Usage](usage.md) is the
setup guide: install, run the gateway, configure it, connect a coding agent and
run the tests.
